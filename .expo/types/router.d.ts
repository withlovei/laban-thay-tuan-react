...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/.DS_Store` | `/AppNavigation` | `/compass-only/components/Background` | `/compass-only/` | `/edit-user-modal/components/Background` | `/edit-user-modal/` | `/huong-nha-book-pdf/` | `/image-picker-modal/` | `/map/` | `/mat-phap-book-pdf/` | `/minh-tuan-book-pdf/` | `/payment/PaymentBottomSheet` | `/payment/PromoCodeInputSheet` | `/phong-thuy-nha-o-book-pdf/` | `/rotate-compass-modal/` | `/search-location-modal/` | `/sidebar/` | `/solution-pdf/` | `/stars-pdf/` | `/table-of-contents-modal/components/Background` | `/table-of-contents-modal/components/SectionItem` | `/table-of-contents-modal/`;
  // prettier-ignore
